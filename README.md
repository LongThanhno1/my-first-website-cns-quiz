...
Website ôn tập trắc nghiệm dành cho nhân viên kỹ thuật (ATSEP) và kiểm soát viên không lưu (ATCO) tại Trung tâm Kiểm soát không lưu Long Thành — VATMSORATS, thuộc Tổng công ty Quản lý bay Việt Nam (VATM).
